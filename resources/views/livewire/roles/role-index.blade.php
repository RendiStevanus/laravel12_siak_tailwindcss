                        ...
                        <tr class="border-b border-gray-100 dark:border-white/[0.05]">
                            <td class="px-4 sm:px-6 py-3.5 text-center">
                                <p class="text-gray-700 text-theme-sm dark:text-gray-400">
                                    {{ $roles->firstItem() + $loop->index }}</p>
                            </td>

                            <td class="px-4 sm:px-6 py-3.5">
                                <p class="text-gray-700 text-theme-sm dark:text-gray-400">{{ $role->name }}</p>
                            </td>
                            <td class="px-4 sm:px-6 py-3.5">
                                <p class="text-gray-700 text-theme-sm dark:text-gray-400">{{ $role->guard_name }}</p>
                            </td>

                            <td class="px-4 sm:px-6 py-3.5">
                                <x-buttons.button-delete :id="$role->id" action="confirmDelete" />
                            </td>
                        </tr>
                    @endforeach
                </tbody>
